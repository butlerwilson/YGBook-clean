...
function login() {
    ...
    document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><B>公告：</B>书友们，请您牢记本站网址并加入收藏，手机也可直接访问，会自动进入手机站！</span>");
...
function footer() {
    ...
    document.writeln("<p>Copyright &copy; 2010-" + new Date().getFullYear() + " All Rights Reserved.</p>");
